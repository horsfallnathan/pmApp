      ...
      var r = t(e),
        ...
        k = function() {
          ...
          ;(t -= n.settings.scrollSpeed / 2),
            ...
            t <= -l.find("li:first-child").outerWidth() &&
              (l.find("li:first-child").insertAfter(l.find("li:last-child")), l.css({ marginLeft: 0 })),
        ...
        v = function() {
          ...
          ;(t -= n.settings.scrollSpeed / 2),
            l.css({ marginRight: t }),
            t <= -l.find("li:first-child").outerWidth() &&
              (l.find("li:first-child").insertAfter(l.find("li:last-child")), l.css({ marginRight: 0 })),
      ...
      ;(n.init = function() {
        if (
          ...
          "fixed-top" === n.settings.position
            ...
            : "fixed-bottom" === n.settings.position &&
              r.addClass("bn-fixed-bottom").css({ "z-index": n.settings.zIndex }),
          "default" != n.settings.fontSize && r.css({ "font-size": n.settings.fontSize }),
          "default" != n.settings.themeColor &&
            (r.css({ "border-color": n.settings.themeColor, color: n.settings.themeColor }),
        ...
        n.settings.play
          ...
          t(window).on("resize", function() {
            r.width() < 480
              ? (o.hide(), "rtl" == n.settings.direction ? a.css({ right: 0 }) : a.css({ left: 0 }))
              : (o.show(),
                "rtl" == n.settings.direction
                  ? a.css({ right: o.outerWidth() })
                  : a.css({ left: o.outerWidth() }))
            ...
            switch (n.settings.effect) {
              case "scroll":
                "rtl" === n.settings.direction
                  ? l
                      .stop()
                      .animate({ marginRight: -l.find("li:first-child").outerWidth() }, 300, function() {
                  ...
                  : l
                      .stop()
                      .animate({ marginLeft: -l.find("li:first-child").outerWidth() }, 300, function() {
                        l.find("li:first-child").insertAfter(l.find("li:last-child")),
                          l.css({ marginLeft: 0 }),
                          (p = !0)
                      })
              ...
              case "scroll":
                "rtl" === n.settings.direction
                  ? (0 <= parseInt(l.css("marginRight"), 10) &&
                      (l.css({ "margin-right": -l.find("li:last-child").outerWidth() }),
                  ...
                  : (0 <= parseInt(l.css("marginLeft"), 10) &&
                      (l.css({ "margin-left": -l.find("li:last-child").outerWidth() }),
                      l.find("li:last-child").insertBefore(l.find("li:first-child"))),
